...
// // const Contact: FC = () => {
// //   const { sectionRef } = useTabAnalytics("contact");

// //   // Analytics: Rastrear visualização da página de contato e tempo gasto
// //   // useEffect(() => {
// //   //   // Rastreia quando a página de contato é carregada
// //   //   trackProfileTabView("contact", {
...
// //   //     trackProfileTabTimeSpent("contact", timeSpent);
// //   //   };
// //   // }, []);
...
// //   return (
// //     <Container sx={{ py: 8 }} component="section" id="contact" ref={sectionRef}>
// //       <motion.div
// //         initial={{ opacity: 0, y: 20 }}
// //         whileInView={{ opacity: 1, y: 0 }}
// //         transition={{ duration: 0.8 }}
